...
while True:
	cashRecieptId += 1
	cashRec=generateCashReceipt(cashRecieptId,'1','1','1','1')
	
	producer.send('test10', json.dumps(cashRec, indent=4, default=json_util.default).encode('utf-8')).add_errback(errorcbk)
